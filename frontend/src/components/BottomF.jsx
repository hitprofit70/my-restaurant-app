    ...
    <div>
      <footer className="footer">
        ...
        <ul className="social-icon">
          ...
          <li className="social-icon__item">
            <Link to="https://www.instagram.com/digitalacademy_za/" className="social-icon__link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <li className="social-icon__item">
            <Link to="https://twitter.com/streetdev" className="social-icon__link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <li className="social-icon__item">
            <Link to="https://www.thedigitalacademy.co.za/" className="social-icon__link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
