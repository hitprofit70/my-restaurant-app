    ...
    return (
        <div>
            ...
            <div className='container mt-5'>
                <h3 className='bg-black text-white text-center' style={{ borderRadius: "5px" }}>Your Cart</h3>
                <div className="items-group" style={{ height: "300px", width: "100%", borderRadius: "5px" }}>
                    <div className="container-fluid">
                        ...
                        <div className=''>
                            ...
                            <button className='checkout-btn'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
